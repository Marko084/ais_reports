<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyPointsDetail.aspx.cs" Inherits="AISReports.SafetyPointsDetail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var tableColumns = GetTableColumnNames($("#safetypoints-grid"));
            ...
            //alert("driver safety points: " + dataUri);
            var ospGrid=$("#safetypoints-grid").DataTable({
                "bDestroy": true,
                "bDeferRender": true,
                ajax: dataUri,
                ...
                rowCallback: function (nRow, aData, iDisplayIndex) {
                    ...
                    var colIndex = $.grep(tableColumns, function (e) { return e.name.toLowerCase() == "pvoname"; });

                    $("td:eq(" + colIndex[0].idx + ")", nRow).html("<a href='#' title='View Driver Details' class='details-link' onclick='javascript: getSearchResults(this); return false;'>" + aData[colIndex[0].idx] + "</a>");
                    //}
                }
            });
        ...
        function displayDetails() {
            ...
            //$(".driver-safety-points-message").text(dataUri);
...
<body>
    ...
    <h1>Driver Safety Points</h1>
        <asp:Panel runat="server" ID="pChart" class="grid-section" grid-query-type="storedproc" grid-type="search" style="width:95%;" >
        ...
        <asp:Panel runat="server" ID="pChart2" class="grid-section" grid-query-type="storedproc" style="width:95%;display:none;" >
        ...
        <asp:Label runat="server" ID="lblMessage" CssClass="driver-safety-points-message" />
    </div>
    <div class="query-parameters-div">
        ...
        <asp:TextBox runat="server" ID="txtEnteredStartDate" data-field-name="EnteredStartDate" />
        <asp:TextBox runat="server" ID="txtEnteredEndDate" data-field-name="EnteredEndDate" />
