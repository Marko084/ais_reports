<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AISClaimsGrid.ascx.cs" Inherits="AISReports.UserControls.AISClaimsGrid" %>
<style type="text/css">
...
<script type="text/javascript">
    ...
    function EditClaimApproval(obj) {
        ...
        if (tableName != "") {
            ...
            if (editMode == "add" || editMode == "save" || editMode == "approve") {
                ...
                $("#ctl00_ContentPlaceHolder1_ctl00_txtTitle").val($(obj).attr("aria-cr-title"));
    ...
    function ViewCheckRequests(obj) {
        ...
        var claimTitle = $(obj).attr("aria-cr-title");
        ...
        if ($("#ctl00_ContentPlaceHolder1_ctl00_pChart").attr("adjustor-approval-module") == "true" &&
            ...
            $("#NewCheckRequestTab").attr("aria-cr-title", claimTitle);
        ...
        $("#ctl00_ContentPlaceHolder1_ctl00_txtTitle").val(claimTitle);
...
<script type="text/javascript">
    ...
    function PrintCheckRequest(obj) {
        ...
        var printUrl = "../reports/ARSCheckRequest.aspx?" + $(obj).attr("rel");
        $("#claims-print-frame").attr("src", printUrl);
    }
