...
{
    public partial class AISSearchFilter : NCDUserControlBase
    {
        #region
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["reports_aismgtConnectionString"].ConnectionString))
            {
                ...
                while (sqlDataReader.Read())
                {
                    ...
                    if (sqlDataReader["FieldType"].ToString().ToLower() == "lookup")
                    {
                        ...
                        child2.ID = string.Format("txt{0}", sqlDataReader["FieldName"].ToString()).ToLower();
                    ...
                    else if (sqlDataReader["FieldType"].ToString().ToLower() == "true/false")
                    {
                        ...
                        child3.ID = string.Format("txt{0}", sqlDataReader["FieldName"].ToString()).ToLower();
                    ...
                    else if (sqlDataReader["FieldType"].ToString().ToLower() == "date")
                    {
                        ...
                        {
                            child2.ID = string.Format("txt{0}", sqlDataReader["FieldName"].ToString()).ToLower().Replace("date", "startdate");
                        ...
                        {
                            child2.ID = string.Format("txt{0}", sqlDataReader["FieldName"].ToString()).ToLower().Replace("date", "enddate");
