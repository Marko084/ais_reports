...
{
    public partial class NCDSearchGridBasic : NCDUserControlBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            pChart.Attributes.Add("grid-type", "search-basic");
        ...
        private string SplitCamelCase(string str) => str.ToLower() == "cscno" ? "CSC No" : Regex.Replace(Regex.Replace(str, "(\\P{Ll})(\\P{Ll}\\p{Ll})", "$1 $2"), "(\\p{Ll})(\\P{Ll})", "$1 $2");
    }
}