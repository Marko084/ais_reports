<%@ WebHandler Language="C#" Class="LytlesHandler" %>
...
public class LytlesHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (queryType.ToLower() == "oldlookup")
            LookupList(context);
        else if (queryType.ToLower() == "lookup")
    ...
    private void GetGridDataResult(HttpContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            context.Response.Write(JsonConvert.SerializeObject(new { error = ex.ToString() }));
        }
