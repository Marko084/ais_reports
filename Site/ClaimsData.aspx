<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MasterPage.Master" AutoEventWireup="true" CodeBehind="ClaimsData.aspx.cs" Inherits="AISReports.Site.ClaimsData" %>
                ...
                <div class="innerwrapper">
                    <asp:PlaceHolder runat="server" ID="phContentCenterColumn">
                        <div style="background-color:#fff;text-align:center;padding:5px;">
                            <img src="../images/avail-demo/claims-data.png" />
                        </div>
                    </asp:PlaceHolder>
                </div>
            </div>
