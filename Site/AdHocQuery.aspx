<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdHocQuery.aspx.cs" Inherits="AISReports.Site.AdHocQuery" %>
...
<asp:Literal runat="server" ID="litScript" EnableViewState="false">
     ...
     <div style="padding-left:40px;" class="adhocquery-div">
        <div id="header">
