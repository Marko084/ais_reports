<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditSurveyResults.aspx.cs" Inherits="AISReports.Site.EditSurveyResults" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding-left:40px;"  class="site-page-div">
        <div id="header">
