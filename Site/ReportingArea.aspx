<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportingArea.aspx.cs" Inherits="AISReports.Site.ReportingArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <uc1:SearchFilter ID="SearchFilter1" runat="server"  />
    <asp:Literal runat="server" ID="litScript" EnableViewState="false">
     ...
     <div style="padding-left:50px;" class="reporting-div">
        <div id="header">
