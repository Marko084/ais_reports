<%@ Page Title="" Language="C#" MasterPageFile="~/Site/MasterPage.Master" AutoEventWireup="true" CodeBehind="GeneralManagerClaims.aspx.cs" Inherits="AISReports.Site.GeneralManagerClaims" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <uc1:SearchFilter ID="SearchFilter1" runat="server"  />
    <asp:Literal runat="server" ID="litScript" EnableViewState="false">
     ...
     <div style="padding-left:40px;" class="general-manager-page">
        <div id="header">
