...
namespace Models
{
    ...
    public class AVLMMISurveyResultsModel
    {
        #region Properties
        [DataMember]
        ...
        public List<AVLMMISurveyResultsModel> GetSurveyData()
        {
            List<AVLMMISurveyResultsModel> results = new List<AVLMMISurveyResultsModel>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["reports_aismgtConnectionString"].ConnectionString))
            {
                ...
                cmd.CommandText = "select * from AVL_MMI_SurveyResults ";

                SqlDataReader dr = cmd.ExecuteReader(CommandBehavior.CloseConnection);

                while (dr.Read())
                {
                    var model = new AVLMMISurveyResultsModel();
