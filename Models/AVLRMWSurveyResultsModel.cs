...
namespace Models
{
    ...
    public class AVLRMWSurveyResultsModel
    {
        #region Properties
        [DataMember]
        ...
        [DataMember]
        public string CoordinatorScore { get; set; } = String.Empty;

        [DataMember]
        public string CourtesyScore { get; set; } = String.Empty;

        [DataMember]
        public string PackingCrewScore { get; set; } = String.Empty;

        [DataMember]
        public string DeliveryCrewScore { get; set; } = String.Empty;

        [DataMember]
        public string TimelinessScore { get; set; } = String.Empty;

        [DataMember]
        public string ResponsivenessScore { get; set; } = String.Empty;

        [DataMember]
        public string OverallAVLScore { get; set; } = String.Empty;
        [DataMember]
        public string TraceShipmentScore { get; set; } = String.Empty;

        [DataMember]
        public string UpdateMoveScore { get; set; } = String.Empty;

        [DataMember]
        public string CSRFlexibilityScore { get; set; } = String.Empty;
        [DataMember]
        public string OverallRMWScore { get; set; } = String.Empty;

        [DataMember]
        public string UseAgain { get; set; } = String.Empty;

        [DataMember]
        public string UseRMWAgain { get; set; } = String.Empty;
        [DataMember]
        ...
        public List<AVLRMWSurveyResultsModel> GetSurveyData()
        {
            List<AVLRMWSurveyResultsModel> results = new List<AVLRMWSurveyResultsModel>();
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["reports_aismgtConnectionString"].ConnectionString))
            {
                ...
                cmd.CommandText = "select * from AVL_RMW_SurveyResults ";

                SqlDataReader dr = cmd.ExecuteReader(CommandBehavior.CloseConnection);

                while (dr.Read())
                {
                    var model = new AVLRMWSurveyResultsModel();
