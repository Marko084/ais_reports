           ...
           $("#site-message-section").text(dataUri);
            ...
            oEditGrid = $(table).dataTable({
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    $('td:eq(0)', nRow).html("<a href='#' rel='" + aData[colIndex] + "' onclick='javascript:RunQuery(this);ShowEditDialog(this); return false;'>Edit</a>&nbsp;<a href='#' rel='" + aData[5] + "' onclick='javascript: RunQuery(this); return false;'>Delete</a>");
                }
            });
