...
function BuildGrid(div) {
    ...
    try {
        ...
        if (DataQuery.QueryParamList == "" && typeof $(div).attr("grid-query-params") !='undefined') {
            DataQuery.QueryParamList = $(div).attr("grid-query-params");
        }
        ...
        if (gridType == "display") {
            $(table).dataTable({
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                 $('td:eq(1)', nRow).attr('style','white-space:nowrap;');
                }
            });
            ...
            oBlogGrid = $(table).dataTable({
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    if (pKeyFieldName == undefined) {
                        ...
                        var colIndex = oBlogGrid.fnGetColumnIndex(pKeyFieldName);
...
function FancyboxPopup(ele) {
    $.fancybox({
        ...
        'onClosed': function () {
            ...
            if ($('.fancybox-iframe').contents().find('.ncd-update-button') != 'undefined') {
                alert("found update button!");
            }
            else {
                alert("didn't find the button!");
            }
        }
