<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PVOPointsDetail.aspx.cs" Inherits="AISReports.PVOPointsDetail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            DataQuery.Query = "GetPVOQualityRating";
        ...
        function displayDetails() {
            ...
            $("#pvopoints-detail-grid").DataTable({
                ...
                dom: '<"fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-tl ui-corner-tr"lfr><"dataTables_scroll"t><"fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-bl ui-corner-br"ip>'
            });
...
<body>
    <form id="form1" runat="server">
        <div style="padding-left: 50px;">
            <h1>Nelson Westerberg PVO Quality Rating</h1>
        ...
        <div class="query-parameters-div" style="display: none;">
            ...
            <asp:TextBox runat="server" ID="txtPVOName" data-field-name="DriverName" />
